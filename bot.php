      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/TlTITITIT",
                   'caption'=>'𝒘𝒆𝒍𝒍𝒄𝒐𝒎𝒆 𝒊𝒏 𝒃𝒐𝒕 𝒉𝒖𝒏𝒕𝒆𝒓 𝒃𝒚- SND🍻',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'𝗔𝗗𝗗 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 𝗙𝗔𝗞𝗘🌿','callback_data'=>'login']],
                          [['text'=>"شرح للبوت 👑",  'url'=>"https://t.me/SND_199"]],
                      ]
                  ])
              ]); 
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 『 SND』','url'=>'t.me/TlTITITIT']],
                          [['text'=>"▪️| 𓆰 SND 2 ℡ᴖ̈💜✨⋮", 'url'=>"https://t.me/SEEHDN"]],
                      ]
                  ])
              ]);   
				}
